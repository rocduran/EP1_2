<?php
include('clases/rss.class.php');//archivo donde este el class 
$rss = new RssReader ("http://finofilipino.org/rss");//aqui donde esta http://dedydamy.com/feed  tienes que poner la url de tu feed o rss
...
foreach ($rss->get_items() as $item){ //aca hacemos un foreach para el array de las entradas que se muestren en el feed 
	...
	$noticia[0] = $titol; 
	$noticia[1] = addslashes($descripcio); 
	$noticia[2] = $url; 
